...
import json
import ubinascii
firmware_url = "https://raw.githubusercontent.com/gitmpelle/pit/main/"

mqtt_server = "m15.cloudmqtt.com"
client_id = ubinascii.hexlify(machine.unique_id())
topic_sub = b"pit001"
topic_pub = b"pit001Msg"
port = 12638
...
# ota_updater = OTAUpdater("TP-Link_2.4GHz", "upperlove", firmware_url, "main.py")
